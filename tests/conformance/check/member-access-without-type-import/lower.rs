...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 1] = ["/example::main"];
    pub static SITES: [Site; 1] = [
        /* terrane-site-row: site 0: /example::main (src/main.trn:7:12-7:27) */
        { Site { function: 0, file: 0, line: 7, column: 12, end_line: 7, end_column: 27 } },
    ];
    #[cold]
    #[inline(never)]
...
// Source: src/snapshot/frame.trn
// Namespace: example/snapshot
#[derive(Clone)]
pub struct FrameState {
    pub bodies: terrane_collection_support::List<FrameBody>,
}
impl FrameState {
