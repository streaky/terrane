...
// Runtime support: async_native.rs, executor_local.rs, async_dependency.rs, time_inactive.rs
...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 3] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:4:14-4:28) */
        { Site { function: 0, file: 0, line: 4, column: 14, end_line: 4, end_column: 28 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:6:25-6:38) */
        { Site { function: 0, file: 0, line: 6, column: 25, end_line: 6, end_column: 38 } },
        /* terrane-site-row: site 2: /app::main (src/main.trn:8:18-8:55) */
        { Site { function: 0, file: 0, line: 8, column: 18, end_line: 8, end_column: 55 } },
    ];
    #[cold]
    #[inline(never)]
                            ...
                            Err(payload) => {
                                Err(
                                    crate::__terrane_dependency_panic(
                                        payload,
                                        "terrane_callback_witness",
                                        "terrane_callback_witness::Marker::value",
                                    ),
                                )
                            }
                        },
...
pub use terrane_callback_witness::Marker;
...
pub fn make_marker(
    value: terrane_int_support::Int,
) -> Result<Marker, crate::TerraneForeignError> {
    let value = terrane_int_support::coerce::<i64>(&value)
        .map_err(|error| crate::TerraneForeignError(
            crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
        ))?;
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_callback_witness::make_marker(value)),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
                crate::__terrane_dependency_panic(
                    payload,
                    "terrane-callback-witness",
                    "terrane_callback_witness::make_marker",
                ),
            )
        }
    }
