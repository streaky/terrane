...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /typed-effect-reflection::exact (case.trn:8:3-8:23) */,
            file: 0,
            line: 8,
            column: 3,
            end_line: 8,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /typed-effect-reflection::main (case.trn:19:5-19:11) */,
            file: 0,
            line: 19,
            column: 5,
            end_line: 19,
