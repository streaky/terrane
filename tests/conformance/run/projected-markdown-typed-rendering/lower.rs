...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:9:9-9:22) */
        { Site { function: 0, file: 0, line: 9, column: 9, end_line: 9, end_column: 22 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:10:14-10:55) */
        { Site { function: 0, file: 0, line: 10, column: 14, end_line: 10, end_column: 55 } },
        /* terrane-site-row: site 2: /app::main (src/main.trn:13:43-13:55) */
        { Site { function: 0, file: 0, line: 13, column: 43, end_line: 13, end_column: 55 } },
        /* terrane-site-row: site 3: /app::main (src/main.trn:13:15-13:56) */
        { Site { function: 0, file: 0, line: 13, column: 15, end_line: 13, end_column: 56 } },
    ];
    #[cold]
    #[inline(never)]
...
// Namespace: app
fn main() {
    let gfm: Options = __terrane_raised(
        terrane_static_trn_4f7074696f6e73_gfm(),
        0 /* terrane-site: src/main.trn:9:9-9:22 */,
    );
    let rendered: String = __terrane_raised(
        to_html_with_options(String::from("~Venus~Mars!"), &gfm),
        1 /* terrane-site: src/main.trn:10:14-10:55 */,
    );
    println!("{}", terrane_scalar_support::scalar_text(&rendered));
    let __terrane_completion_0: TerraneCompletion<()> = (|| {
        let __terrane_try_0: TerraneCompletion<()> = (|| {
            let invalid: String = __terrane_raised_completion!(
                to_html_with_options(String::from("{"),
                &__terrane_raised_completion!(mdx_options(), 2 /* terrane-site: src/main.trn:13:43-13:55 */)), 3 /* terrane-site: src/main.trn:13:15-13:56 */
            );
            println!("{}", terrane_scalar_support::scalar_text(&invalid));
...
// Source: <terrane>/projected/deps/markdown/message.trn
// Namespace: deps/markdown/message
// Source: <terrane>/projected/deps/terrane-markdown-error-witness.trn
// Namespace: deps/terrane-markdown-error-witness
pub fn mdx_options() -> Result<Options, crate::TerraneForeignError> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_markdown_error_witness::mdx_options()),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
                crate::__terrane_dependency_panic(
                    payload,
                    "terrane-markdown-error-witness",
                    "terrane_markdown_error_witness::mdx_options",
                ),
            )
        }
    }
