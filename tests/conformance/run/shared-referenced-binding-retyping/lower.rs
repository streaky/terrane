...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /shared-referenced-binding-retyping::main (case.trn:9:12-9:20) */,
            file: 0,
            line: 9,
            column: 12,
            end_line: 9,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /shared-referenced-binding-retyping::main (case.trn:9:12-9:20) */,
            file: 0,
            line: 9,
            column: 12,
            end_line: 9,
        ...
        Site {
            function: 
                0 /* terrane-site: site 2: /shared-referenced-binding-retyping::main (case.trn:9:22-9:30) */,
            file: 0,
            line: 9,
            column: 22,
            end_line: 9,
        ...
        Site {
            function: 
                0 /* terrane-site: site 3: /shared-referenced-binding-retyping::main (case.trn:9:22-9:30) */,
            file: 0,
            line: 9,
            column: 22,
            end_line: 9,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:9:12-9:20 */)), 1 /* terrane-site: case.trn:9:12-9:20 */)),
        terrane_scalar_support::scalar_text(&__terrane_raised(value
        .get_or_error(__terrane_raised(terrane_collection_support::index_from_int(&terrane_int_support::Int::from(0_i128)),
        2 /* terrane-site: case.trn:9:22-9:30 */)), 3 /* terrane-site: case.trn:9:22-9:30 */))
    );
}
