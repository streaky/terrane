...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 6] = [
        "/text-stream-decode-failure::read-all",
        "/text-stream-decode-failure::main",
    ...
    pub static SITES: [Site; 6] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /text-stream-decode-failure::read-all (case.trn:6:15-6:33) */,
            file: 0,
            line: 6,
            column: 15,
            end_line: 6,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /text-stream-decode-failure::main (case.trn:14:17-14:37) */,
            file: 0,
            line: 14,
            column: 17,
            end_line: 14,
        ...
        Site {
            function: 
                2 /* terrane-site: site 2: /standard/streams::read (standard/streams.trn:195:23-195:50) */,
            file: 1,
            line: 195,
            column: 23,
            end_line: 195,
        ...
        Site {
            function: 
                3 /* terrane-site: site 3: /standard/streams::read-exact (standard/streams.trn:217:23-217:46) */,
            file: 1,
            line: 217,
            column: 23,
            end_line: 217,
        ...
        Site {
            function: 
                4 /* terrane-site: site 4: /standard/streams::read-all (standard/streams.trn:236:23-236:46) */,
            file: 1,
            line: 236,
            column: 23,
            end_line: 236,
        ...
        Site {
            function: 
                5 /* terrane-site: site 5: /standard/streams::read-async (standard/streams.trn:240:16-240:32) */,
            file: 1,
            line: 240,
            column: 16,
            end_line: 240,
