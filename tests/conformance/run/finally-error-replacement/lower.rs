...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /finally-error-replacement::error-then-return (case.trn:5:5-5:30) */,
            file: 0,
            line: 5,
            column: 5,
            end_line: 5,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /finally-error-replacement::return-then-error (case.trn:12:5-12:25) */,
            file: 0,
            line: 12,
            column: 5,
            end_line: 12,
        ...
        Site {
            function: 
                2 /* terrane-site: site 2: /finally-error-replacement::main (case.trn:14:15-14:33) */,
            file: 0,
            line: 14,
            column: 15,
            end_line: 14,
        ...
        Site {
            function: 
                2 /* terrane-site: site 3: /finally-error-replacement::main (case.trn:17:18-17:36) */,
            file: 0,
            line: 17,
            column: 18,
            end_line: 17,
