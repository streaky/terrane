...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:7:7-7:15) */
        { Site { function: 0, file: 0, line: 7, column: 7, end_line: 7, end_column: 15 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:8:7-8:16) */
        { Site { function: 0, file: 0, line: 8, column: 7, end_line: 8, end_column: 16 } },
    ];
    #[cold]
    #[inline(never)]
...
fn main() {
    {
        let _: First = __terrane_raised(
            first(terrane_int_support::Int::from(1_i128)),
            0 /* terrane-site: src/main.trn:7:7-7:15 */,
        );
    }
    {
        let _: Second = __terrane_raised(
            second(terrane_int_support::Int::from(2_i128)),
            1 /* terrane-site: src/main.trn:8:7-8:16 */,
        );
    }
    println!(
        "{}",
        terrane_scalar_support::scalar_text(&String::from("colliding trait method declined"))
    );
}
