...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 3] = [
        "/parse-radix-families::from-hex",
        "/parse-radix-families::fail",
    ...
    pub static SITES: [Site; 3] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /parse-radix-families::from-hex (case.trn:5:10-5:26) */,
            file: 0,
            line: 5,
            column: 10,
            end_line: 5,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /parse-radix-families::fail (case.trn:8:3-8:23) */,
            file: 0,
            line: 8,
            column: 3,
            end_line: 8,
        ...
        Site {
            function: 
                2 /* terrane-site: site 2: /parse-radix-families::main (case.trn:14:11-14:26) */,
            file: 0,
            line: 14,
            column: 11,
            end_line: 14,
