...
fn main() {
    __terrane_run(async move {
        ...
        let mut __terrane_select_cancelled_148_0 = false;
        ...
        let mut __terrane_select_cancelled_148_1 = false;
        let __terrane_select_winner_148 = std::future::poll_fn(|
                __terrane_select_context|
            {
                    ...
                    match __terrane_select_candidate {
                        0 => {
                            match Future::poll(
                                ...
                                std::task::Poll::Ready(None) => {
                                    __terrane_select_cancelled_148_0 = true;
                                }
                                std::task::Poll::Pending => {}
                            }
                        }
                        1 => {
                            match Future::poll(
                                ...
                                std::task::Poll::Ready(None) => {
                                    __terrane_select_cancelled_148_1 = true;
                                }
                                std::task::Poll::Pending => {}
                            }
                        }
                ...
                if __terrane_select_cancelled_148_0 && __terrane_select_cancelled_148_1 {
                    return std::task::Poll::Ready(usize::MAX);
                }
                std::task::Poll::Pending
            })
        ...
        if __terrane_select_winner_148 == usize::MAX {
            ...
            if !__terrane_select_cancelled_148_1 {
                let _ = __terrane_select_future_148_1.as_mut().await;
            }
            if !__terrane_select_cancelled_148_0 {
                let _ = __terrane_select_future_148_0.as_mut().await;
            }
            drop(__terrane_select_future_148_1);
            drop(__terrane_select_future_148_0);
            __terrane_wait_projected_cleanups().await;
            __terrane_select_guard_148.finish();
            __terrane_finish_cancelled_select(__terrane_select_guard_148).await;
        }
        __terrane_select_cursor_148 = (__terrane_select_winner_148 + 1usize) % 2usize;
