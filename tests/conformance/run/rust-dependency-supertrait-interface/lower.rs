...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:16:13-16:44) */
        { Site { function: 0, file: 0, line: 16, column: 13, end_line: 16, end_column: 44 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:17:13-17:51) */
        { Site { function: 0, file: 0, line: 17, column: 13, end_line: 17, end_column: 51 } },
    ];
    #[cold]
    #[inline(never)]
...
impl terrane_supertrait_witness::Base for Values {
    fn base(&self) -> i64 {
        let __terrane_boundary: Result<i64, crate::TerraneForeignError> = (|| {
            let __terrane_value = <Values>::base(&*self);
            Ok(
                terrane_int_support::coerce::<i64>(&__terrane_value)
                    .map_err(|error| crate::TerraneForeignError(
                        crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
...
impl terrane_supertrait_witness::Base for Base {
    fn base(&self) -> i64 {
        let __terrane_boundary: Result<i64, crate::TerraneForeignError> = (|| {
            let __terrane_value = <Base>::base(&*self);
            Ok(
                terrane_int_support::coerce::<i64>(&__terrane_value)
                    .map_err(|error| crate::TerraneForeignError(
                        crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
...
impl terrane_supertrait_witness::Base for Child {
    fn base(&self) -> i64 {
        let __terrane_boundary: Result<i64, crate::TerraneForeignError> = (|| {
            let __terrane_value = <Child>::base(&*self);
            Ok(
                terrane_int_support::coerce::<i64>(&__terrane_value)
                    .map_err(|error| crate::TerraneForeignError(
                        crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
...
impl terrane_supertrait_witness::Base for Middle {
    fn base(&self) -> i64 {
        let __terrane_boundary: Result<i64, crate::TerraneForeignError> = (|| {
            let __terrane_value = <Middle>::base(&*self);
            Ok(
                terrane_int_support::coerce::<i64>(&__terrane_value)
                    .map_err(|error| crate::TerraneForeignError(
                        crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
