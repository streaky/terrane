...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 6] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:8:11-8:32) */
        { Site { function: 0, file: 0, line: 8, column: 11, end_line: 8, end_column: 32 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:9:15-9:38) */
        { Site { function: 0, file: 0, line: 9, column: 15, end_line: 9, end_column: 38 } },
        /* terrane-site-row: site 2: /app::main (src/main.trn:10:13-10:26) */
        { Site { function: 0, file: 0, line: 10, column: 13, end_line: 10, end_column: 26 } },
        /* terrane-site-row: site 3: /app::main (src/main.trn:11:17-11:63) */
        { Site { function: 0, file: 0, line: 11, column: 17, end_line: 11, end_column: 63 } },
        /* terrane-site-row: site 4: /app::main (src/main.trn:12:11-12:23) */
        { Site { function: 0, file: 0, line: 12, column: 11, end_line: 12, end_column: 23 } },
        /* terrane-site-row: site 5: /app::main (src/main.trn:12:27-12:43) */
        { Site { function: 0, file: 0, line: 12, column: 27, end_line: 12, end_column: 43 } },
    ];
    #[cold]
    #[inline(never)]
...
// Namespace: app
fn main() {
    let plain: PlainOwner = __terrane_raised(
        terrane_static_trn_506c61696e4f776e6572_standard(),
        0 /* terrane-site: src/main.trn:8:11-8:32 */,
    );
    let defaulted: DefaultOwner = __terrane_raised(
        terrane_static_trn_44656661756c744f776e6572_standard(),
        1 /* terrane-site: src/main.trn:9:15-9:38 */,
    );
    let options: Options = __terrane_raised(
        terrane_static_trn_4f7074696f6e73_gfm(),
        2 /* terrane-site: src/main.trn:10:13-10:26 */,
    );
    let html: String = __terrane_raised(
        to_html_with_options(String::from("|a|\n|-|\n|b|"), &options),
    ...
    println!(
        ...
        "terrane_owner_witness::PlainOwner::label")) }, 4 /* terrane-site: src/main.trn:12:11-12:23 */)),
        terrane_scalar_support::scalar_text(&__terrane_raised(match
...
> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| markdown::Options::gfm()),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
...
> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_owner_witness::DefaultOwner::<
            String,
        >::standard()),
    ) {
        Ok(value) => Ok(value),
...
pub fn terrane_static_trn_506c61696e4f776e6572_standard() -> Result<
    PlainOwner,
    crate::TerraneForeignError,
> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_owner_witness::PlainOwner::standard()),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
                crate::__terrane_dependency_panic(
                    payload,
                    "terrane-owner-witness",
                    "terrane_owner_witness::PlainOwner",
                ),
            )
        }
    }
