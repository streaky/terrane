...
fn main() {
    ...
    println!(
        ...
        std::panic::catch_unwind(std::panic::AssertUnwindSafe(| | left.value())) {
...
pub use terrane_member_graph_witness::left::Left;
pub fn terrane_static_trn_4c656674_new() -> Result<Left, crate::TerraneForeignError> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_member_graph_witness::left::Left::new()),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
                crate::__terrane_dependency_panic(
                    ...
                    "terrane_member_graph_witness::left::Left",
                ),
            )
        }
    }
