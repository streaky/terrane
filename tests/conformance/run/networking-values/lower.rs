...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 11] = [
        ...
        { Site { function: 2, file: 2, line: 62, column: 13, end_line: 62, end_column: 45 } },
        /* terrane-site-row: site 3: /core/time::seconds (core/time.trn:38:13-38:45) */
        { Site { function: 3, file: 2, line: 38, column: 13, end_line: 38, end_column: 45 } },
        /* terrane-site-row: site 4: /core/time::milliseconds (core/time.trn:43:13-43:45) */
        { Site { function: 4, file: 2, line: 43, column: 13, end_line: 43, end_column: 45 } },
        /* terrane-site-row: site 5: /core/time::microseconds (core/time.trn:48:13-48:45) */
        { Site { function: 5, file: 2, line: 48, column: 13, end_line: 48, end_column: 45 } },
        /* terrane-site-row: site 6: /core/time::nanoseconds (core/time.trn:53:13-53:45) */
        { Site { function: 6, file: 2, line: 53, column: 13, end_line: 53, end_column: 45 } },
        /* terrane-site-row: site 7: /core/time::duration-until (core/time.trn:76:13-76:45) */
        { Site { function: 7, file: 2, line: 76, column: 13, end_line: 76, end_column: 45 } },
        /* terrane-site-row: site 8: /core/time::at (core/time.trn:105:13-105:45) */
        { Site { function: 8, file: 2, line: 105, column: 13, end_line: 105, end_column: 45 } },
        /* terrane-site-row: site 9: /core/time::sleep-until (core/time.trn:162:13-162:45) */
        { Site { function: 9, file: 2, line: 162, column: 13, end_line: 162, end_column: 45 } },
        /* terrane-site-row: site 10: /core/time::interval (core/time.trn:173:13-173:45) */
        { Site { function: 10, file: 2, line: 173, column: 13, end_line: 173, end_column: 45 } },
    ];
    #[cold]
    #[inline(never)]
        ...
        if multiplier.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    ...
                    value.render(),
                    2 /* terrane-site: core/time.trn:62:13-62:45 */,
                )
            });
        }
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    3 /* terrane-site: core/time.trn:38:13-38:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    4 /* terrane-site: core/time.trn:43:13-43:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    5 /* terrane-site: core/time.trn:48:13-48:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    6 /* terrane-site: core/time.trn:53:13-53:45 */,
                )
            });
        }
        return Ok(
                ...
                < self.elapsed_nanoseconds.clone()
        {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    7 /* terrane-site: core/time.trn:76:13-76:45 */,
                )
            });
        }
        ...
        if target.domain.clone() != terrane_platform_time_domain() {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    8 /* terrane-site: core/time.trn:105:13-105:45 */,
                )
            });
        }
        ...
        if target.domain.clone() != terrane_platform_time_domain() {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    9 /* terrane-site: core/time.trn:162:13-162:45 */,
                )
            });
        }
        return Ok(
        ...
        if period.total_nanoseconds.clone() == terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    10 /* terrane-site: core/time.trn:173:13-173:45 */,
                )
            });
        }
