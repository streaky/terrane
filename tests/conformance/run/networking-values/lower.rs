...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 11] = [
        ...
        /* terrane-site-row: site 9: /core/time::sleep-until (core/time.trn:161:13-161:45) */
        { Site { function: 9, file: 2, line: 161, column: 13, end_line: 161, end_column: 45 } },
        /* terrane-site-row: site 10: /core/time::interval (core/time.trn:172:13-172:45) */
        { Site { function: 10, file: 2, line: 172, column: 13, end_line: 172, end_column: 45 } },
    ];
    #[cold]
    #[inline(never)]
        ...
        if target.domain.clone() != terrane_platform_time_domain() {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    9 /* terrane-site: core/time.trn:161:13-161:45 */,
                )
            });
        }
        return Ok(
        ...
        if period.total_nanoseconds.clone() == terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    10 /* terrane-site: core/time.trn:172:13-172:45 */,
                )
            });
        }
