...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 3] = [
        /* terrane-site-row: site 0: /app::main (src/main.trn:5:21-5:28) */
        { Site { function: 0, file: 0, line: 5, column: 21, end_line: 5, end_column: 28 } },
        /* terrane-site-row: site 1: /app::main (src/main.trn:5:32-5:39) */
        { Site { function: 0, file: 0, line: 5, column: 32, end_line: 5, end_column: 39 } },
        /* terrane-site-row: site 2: /app::main (src/main.trn:6:13-6:32) */
        { Site { function: 0, file: 0, line: 6, column: 13, end_line: 6, end_column: 32 } },
    ];
    #[cold]
    #[inline(never)]
...
// Namespace: app
fn main() {
    let values: terrane_collection_support::List<Widget> = terrane_collection_support::List::<
        Widget,
    >::new(
        vec![
            __terrane_raised(widget(), 0 /* terrane-site: src/main.trn:5:21-5:28 */),
...
pub use terrane_render_witness::Widget;
pub fn widget() -> Result<Widget, crate::TerraneForeignError> {
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_render_witness::widget()),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
