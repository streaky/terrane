...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /scalar-reference-transparency::main (case.trn:14:13-14:33) */,
            file: 0,
            line: 14,
            column: 13,
            end_line: 14,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /scalar-reference-transparency::main (case.trn:19:13-19:28) */,
            file: 0,
            line: 19,
            column: 13,
            end_line: 19,
        ...
        Site {
            function: 
                0 /* terrane-site: site 2: /scalar-reference-transparency::main (case.trn:20:12-20:24) */,
            file: 0,
            line: 20,
            column: 12,
            end_line: 20,
        ...
        Site {
            function: 
                0 /* terrane-site: site 3: /scalar-reference-transparency::main (case.trn:24:12-24:21) */,
            file: 0,
            line: 24,
            column: 12,
            end_line: 24,
