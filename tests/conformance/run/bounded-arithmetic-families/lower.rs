...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 21] = [
        {
            /* terrane-site-row: site 0: /bounded-arithmetic-families::main (case.trn:9:10-9:26) */
            Site {
                function: 0,
                file: 0,
                line: 9,
        ...
        {
            /* terrane-site-row: site 1: /bounded-arithmetic-families::main (case.trn:15:11-15:26) */
            Site {
                function: 0,
                file: 0,
                line: 15,
        ...
        {
            /* terrane-site-row: site 2: /bounded-arithmetic-families::main (case.trn:15:30-15:48) */
            Site {
                function: 0,
                file: 0,
                line: 15,
        ...
        {
            /* terrane-site-row: site 3: /bounded-arithmetic-families::main (case.trn:18:11-18:35) */
            Site {
                function: 0,
                file: 0,
                line: 18,
        ...
        {
            /* terrane-site-row: site 4: /bounded-arithmetic-families::main (case.trn:19:3-19:31) */
            Site {
                function: 0,
                file: 0,
                line: 19,
        ...
        {
            /* terrane-site-row: site 5: /bounded-arithmetic-families::main (case.trn:21:3-21:10) */
            Site {
                function: 0,
                file: 0,
                line: 21,
        ...
        {
            /* terrane-site-row: site 6: /bounded-arithmetic-families::main (case.trn:22:3-22:10) */
            Site {
                function: 0,
                file: 0,
                line: 22,
        ...
        {
            /* terrane-site-row: site 7: /bounded-arithmetic-families::main (case.trn:32:11-32:34) */
            Site {
                function: 0,
                file: 0,
                line: 32,
        ...
        {
            /* terrane-site-row: site 8: /bounded-arithmetic-families::main (case.trn:32:38-32:65) */
            Site {
                function: 0,
                file: 0,
                line: 32,
        ...
        {
            /* terrane-site-row: site 9: /bounded-arithmetic-families::main (case.trn:33:18-33:48) */
            Site {
                function: 0,
                file: 0,
                line: 33,
        ...
        {
            /* terrane-site-row: site 10: /bounded-arithmetic-families::main (case.trn:34:56-34:82) */
            Site {
                function: 0,
                file: 0,
                line: 34,
        ...
        {
            /* terrane-site-row: site 11: /bounded-arithmetic-families::main (case.trn:35:18-35:51) */
            Site {
                function: 0,
                file: 0,
                line: 35,
        ...
        {
            /* terrane-site-row: site 12: /bounded-arithmetic-families::main (case.trn:36:11-36:37) */
            Site {
                function: 0,
                file: 0,
                line: 36,
        ...
        {
            /* terrane-site-row: site 13: /bounded-arithmetic-families::main (case.trn:36:41-36:71) */
            Site {
                function: 0,
                file: 0,
                line: 36,
        ...
        {
            /* terrane-site-row: site 14: /bounded-arithmetic-families::main (case.trn:37:56-37:85) */
            Site {
                function: 0,
                file: 0,
                line: 37,
        ...
        {
            /* terrane-site-row: site 15: /bounded-arithmetic-families::main (case.trn:38:11-38:26) */
            Site {
                function: 0,
                file: 0,
                line: 38,
        ...
        {
            /* terrane-site-row: site 16: /bounded-arithmetic-families::main (case.trn:38:30-38:48) */
            Site {
                function: 0,
                file: 0,
                line: 38,
        ...
        {
            /* terrane-site-row: site 17: /bounded-arithmetic-families::main (case.trn:39:11-39:25) */
            Site {
                function: 0,
                file: 0,
                line: 39,
        ...
        {
            /* terrane-site-row: site 18: /bounded-arithmetic-families::main (case.trn:39:29-39:46) */
            Site {
                function: 0,
                file: 0,
                line: 39,
        ...
        {
            /* terrane-site-row: site 19: /bounded-arithmetic-families::main (case.trn:40:11-40:27) */
            Site {
                function: 0,
                file: 0,
                line: 40,
        ...
        {
            /* terrane-site-row: site 20: /bounded-arithmetic-families::main (case.trn:40:31-40:50) */
            Site {
                function: 0,
                file: 0,
                line: 40,
...
fn main() {
    ...
    let div_overflow: terrane_int_support::OverflowResult<i8> = __terrane_raised(
        ...
        9 /* terrane-site: case.trn:33:18-33:48 */,
    );
    println!(
        ...
        - 1), 10 /* terrane-site: case.trn:34:56-34:82 */).is_none())
    );
    ...
    println!(
        ...
        - 1), 14 /* terrane-site: case.trn:37:56-37:85 */).is_none())
    );
    println!(
        "{}{}",
        ...
        15 /* terrane-site: case.trn:38:11-38:26 */)),
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_int_support::Int::from(-
        7_i128).modulo(&terrane_int_support::Int::from(3_i128)), 16 /* terrane-site: case.trn:38:30-38:48 */))
    );
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_int_support::Int::from(7_i128)
        .euclidean_div(&- terrane_int_support::Int::from(3_i128)), 17 /* terrane-site: case.trn:39:11-39:25 */)),
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_int_support::Int::from(7_i128)
        .modulo(&- terrane_int_support::Int::from(3_i128)), 18 /* terrane-site: case.trn:39:29-39:46 */))
    );
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_int_support::Int::from(-
        7_i128).euclidean_div(&- terrane_int_support::Int::from(3_i128)),
        19 /* terrane-site: case.trn:40:11-40:27 */)),
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_int_support::Int::from(-
        7_i128).modulo(&- terrane_int_support::Int::from(3_i128)), 20 /* terrane-site: case.trn:40:31-40:50 */))
    );
}
