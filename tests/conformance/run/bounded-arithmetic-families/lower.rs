...
fn main() {
    ...
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_division(small,
        3))),
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_remainder(small,
        7)))
    );
    ...
    println!(
        "{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_shift_left_wrap(small,
        &1)))
    );
    ...
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_division_wrap(minimum,
        - 1))),
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_division_saturate(minimum,
        - 1)))
    );
    ...
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_remainder_wrap(minimum,
        - 1))),
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::fixed_remainder_saturate(minimum,
        - 1)))
    );
    println!(
    ...
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::Int::from(-
        7_i128).euclidean_div(&terrane_int_support::Int::from(3_i128)))),
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::Int::from(-
        7_i128).modulo(&terrane_int_support::Int::from(3_i128))))
    );
    println!(
        "{}{}",
        terrane_scalar_support::scalar_text(&terrane_int_support::unwrap_or_fail(terrane_int_support::Int::from(7_i128)
