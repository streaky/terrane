...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /nested-collection-contextual-typing::main (case.trn:6:10-6:18) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /nested-collection-contextual-typing::main (case.trn:6:10-6:18) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
        ...
        Site {
            function: 
                0 /* terrane-site: site 2: /nested-collection-contextual-typing::main (case.trn:6:10-6:21) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
        ...
        Site {
            function: 
                0 /* terrane-site: site 3: /nested-collection-contextual-typing::main (case.trn:6:10-6:21) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:6:10-6:18 */)), 1 /* terrane-site: case.trn:6:10-6:18 */)
        .get_or_error(__terrane_raised(terrane_collection_support::index_from_int(&terrane_int_support::Int::from(1_i128)),
        2 /* terrane-site: case.trn:6:10-6:21 */)), 3 /* terrane-site: case.trn:6:10-6:21 */))
    );
}
