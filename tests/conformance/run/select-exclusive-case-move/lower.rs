...
fn main() {
    __terrane_run(async move {
        ...
        let mut __terrane_select_cancelled_157_0 = false;
        ...
        let mut __terrane_select_cancelled_157_1 = false;
        let __terrane_select_winner_157 = std::future::poll_fn(|
                __terrane_select_context|
            {
                    ...
                    match __terrane_select_candidate {
                        0 => {
                            match Future::poll(
                                ...
                                std::task::Poll::Ready(None) => {
                                    __terrane_select_cancelled_157_0 = true;
                                }
                                std::task::Poll::Pending => {}
                            }
                        }
                        1 => {
                            match Future::poll(
                                ...
                                std::task::Poll::Ready(None) => {
                                    __terrane_select_cancelled_157_1 = true;
                                }
                                std::task::Poll::Pending => {}
                            }
                        }
                ...
                if __terrane_select_cancelled_157_0 && __terrane_select_cancelled_157_1 {
                    return std::task::Poll::Ready(usize::MAX);
                }
                std::task::Poll::Pending
            })
        ...
        if __terrane_select_winner_157 == usize::MAX {
            ...
            if !__terrane_select_cancelled_157_1 {
                let _ = __terrane_select_future_157_1.as_mut().await;
            }
            if !__terrane_select_cancelled_157_0 {
                let _ = __terrane_select_future_157_0.as_mut().await;
            }
            drop(__terrane_select_future_157_1);
            drop(__terrane_select_future_157_0);
            __terrane_wait_projected_cleanups().await;
            __terrane_select_guard_157.finish();
            __terrane_finish_cancelled_select(__terrane_select_guard_157).await;
        }
        __terrane_select_cursor_157 = (__terrane_select_winner_157 + 1usize) % 2usize;
        ...
        match __terrane_select_winner_157 {
            0 => {
                ...
                println!(
                    ...
                    terrane_scalar_support::scalar_text(&__terrane_await(pending). await)
                );
            }
            1 => {
