...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = ["/app", "/app::read"];
    pub static SITES: [Site; 2] = [
        /* terrane-site-row: site 0: /app (src/main.trn:6:20-6:37) */
        { Site { function: 0, file: 0, line: 6, column: 20, end_line: 6, end_column: 37 } },
        /* terrane-site-row: site 1: /app::read (src/main.trn:9:12-9:28) */
        { Site { function: 1, file: 0, line: 9, column: 12, end_line: 9, end_column: 28 } },
    ];
    #[cold]
    #[inline(never)]
