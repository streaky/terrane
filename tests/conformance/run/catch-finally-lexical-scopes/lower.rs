...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = [
        "/catch-finally-lexical-scopes::typed-catch",
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /catch-finally-lexical-scopes::typed-catch (case.trn:6:5-6:30) */,
            file: 0,
            line: 6,
            column: 5,
            end_line: 6,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /catch-finally-lexical-scopes::catch-all (case.trn:16:5-16:25) */,
            file: 0,
            line: 16,
            column: 5,
            end_line: 16,
