...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /loop-shadowing-scope::main (case.trn:24:10-24:20) */,
            file: 0,
            line: 24,
            column: 10,
            end_line: 24,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /loop-shadowing-scope::main (case.trn:24:10-24:20) */,
            file: 0,
            line: 24,
            column: 10,
            end_line: 24,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:24:10-24:20 */)), 1 /* terrane-site: case.trn:24:10-24:20 */))
    );
