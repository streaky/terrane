...
fn main() {
    println!(
        ...
        terrane_opaque_result_witness::make(match | | -> Result < _, crate
        ::TerraneForeignError > { Ok(terrane_int_support::coerce:: < u32 >
        (&terrane_int_support::Int::from(42_i128)).map_err(| error | crate
