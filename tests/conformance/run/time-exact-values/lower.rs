...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 19] = [
        ...
        /* terrane-site-row: site 10: /core/time::multiply (core/time.trn:61:13-61:45) */
        { Site { function: 1, file: 1, line: 61, column: 13, end_line: 61, end_column: 45 } },
        /* terrane-site-row: site 11: /core/time::seconds (core/time.trn:37:13-37:45) */
        { Site { function: 2, file: 1, line: 37, column: 13, end_line: 37, end_column: 45 } },
        /* terrane-site-row: site 12: /core/time::milliseconds (core/time.trn:42:13-42:45) */
        { Site { function: 3, file: 1, line: 42, column: 13, end_line: 42, end_column: 45 } },
        /* terrane-site-row: site 13: /core/time::microseconds (core/time.trn:47:13-47:45) */
        { Site { function: 4, file: 1, line: 47, column: 13, end_line: 47, end_column: 45 } },
        /* terrane-site-row: site 14: /core/time::nanoseconds (core/time.trn:52:13-52:45) */
        { Site { function: 5, file: 1, line: 52, column: 13, end_line: 52, end_column: 45 } },
        /* terrane-site-row: site 15: /core/time::duration-until (core/time.trn:75:13-75:45) */
        { Site { function: 6, file: 1, line: 75, column: 13, end_line: 75, end_column: 45 } },
        /* terrane-site-row: site 16: /core/time::at (core/time.trn:104:13-104:45) */
        { Site { function: 7, file: 1, line: 104, column: 13, end_line: 104, end_column: 45 } },
        /* terrane-site-row: site 17: /core/time::sleep-until (core/time.trn:157:13-157:45) */
        { Site { function: 8, file: 1, line: 157, column: 13, end_line: 157, end_column: 45 } },
        /* terrane-site-row: site 18: /core/time::interval (core/time.trn:168:13-168:45) */
        ...
        if multiplier.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    10 /* terrane-site: core/time.trn:61:13-61:45 */,
                )
            });
        }
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    11 /* terrane-site: core/time.trn:37:13-37:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    12 /* terrane-site: core/time.trn:42:13-42:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    13 /* terrane-site: core/time.trn:47:13-47:45 */,
                )
            });
        }
        return Ok(
        ...
        if value.clone() < terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    14 /* terrane-site: core/time.trn:52:13-52:45 */,
                )
            });
        }
        return Ok(
                ...
                < self.elapsed_nanoseconds.clone()
        {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    15 /* terrane-site: core/time.trn:75:13-75:45 */,
                )
            });
        }
        ...
        if target.domain.clone() != terrane_platform_time_domain() {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    16 /* terrane-site: core/time.trn:104:13-104:45 */,
                )
            });
        }
        ...
        if target.domain.clone() != terrane_platform_time_domain() {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    17 /* terrane-site: core/time.trn:157:13-157:45 */,
                )
            });
        }
        return Ok(
        ...
        if period.total_nanoseconds.clone() == terrane_int_support::Int::from(0_i128) {
            return Err({
                ...
                TerraneError::raised_with_message(
                    TerraneErrorKind::Custom(DescriptorId(0)),
                    value.render(),
                    18 /* terrane-site: core/time.trn:168:13-168:45 */,
                )
            });
        }
