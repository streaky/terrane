...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = [
        "/custom-throwable::load",
        "/custom-throwable::main",
    ];
    #[allow(dead_code, reason = "custom descriptors are absent from some programs")]
    pub static DESCRIPTORS: [&str; 1] = ["config-error"];
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /custom-throwable::load (case.trn:14:3-14:54) */,
            file: 0,
            line: 14,
            column: 3,
            end_line: 14,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /custom-throwable::main (case.trn:18:5-18:25) */,
            file: 0,
            line: 18,
            column: 5,
            end_line: 18,
