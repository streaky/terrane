...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = [
        "/uncaught-detailed-coercion::narrow",
        "/uncaught-detailed-coercion::main",
    ];
    pub static SITES: [Site; 2] = [
        {
            /* terrane-site-row: site 0: /uncaught-detailed-coercion::narrow (case.trn:5:10-5:15) */
            Site {
                function: 0,
                file: 0,
                line: 5,
        ...
        {
            /* terrane-site-row: site 1: /uncaught-detailed-coercion::main (case.trn:10:5-10:10) */
            Site {
                function: 1,
                file: 0,
                line: 10,
...
fn narrow(value: terrane_int_support::Int) -> i8 {
...
fn main() {
    let __terrane_completion_0: TerraneCompletion<()> = (|| {
        let __terrane_try_0: TerraneCompletion<()> = (|| {
            println!(
                "{}",
                terrane_scalar_support::scalar_text(&narrow(terrane_int_support::Int::from(300_i128)))
            );
            ...
            TerraneCompletion::Error(__terrane_error_0) => {
                        ...
                        == TerraneErrorKind::IntegerConversionOverflow
                {
                    ...
                    return TerraneCompletion::Error(
                        __terrane_error_0
                            .clone()
                            .at(1 /* terrane-site: case.trn:10:5-10:10 */),
                    );
                }
                if !__terrane_handled_0 {
