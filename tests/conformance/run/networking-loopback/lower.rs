...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 3] = [
        Site {
            function: 0 /* terrane-site: site 0: /app::main (case.trn:20:13-20:39) */,
            file: 0,
            line: 20,
            column: 13,
            end_line: 20,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /standard/networking::lookup-dns (standard/networking.trn:326:28-326:49) */,
            file: 1,
            line: 326,
            column: 28,
            end_line: 326,
        ...
        Site {
            function: 
                1 /* terrane-site: site 2: /standard/networking::lookup-dns (standard/networking.trn:326:28-326:49) */,
            file: 1,
            line: 326,
            column: 28,
            end_line: 326,
...
fn main() {
    ...
    println!(
        "{}",
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_string_support::decode(&received
        .data, terrane_string_support::Encoding::Utf8), 0 /* terrane-site: case.trn:20:13-20:39 */))
    );
        ...
        candidates
            .append(
                __terrane_raised(
                    ...
                    2 /* terrane-site: standard/networking.trn:326:28-326:49 */,
                ),
            );
