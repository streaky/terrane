...
// Runtime support: async.rs, executor_parallel.rs, platform_streams.rs, platform_standard_streams.rs, platform_capability_types.rs, platform_result_type.rs, platform_int_conversion.rs, platform_capability_base.rs, platform_networking.rs
...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 6] = [
        ...
        { Site { function: 1, file: 1, line: 319, column: 28, end_line: 319, end_column: 49 } },
