...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 8] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /standard/urls::get (standard/urls.trn:29:16-29:32) */,
            file: 0,
            line: 29,
            column: 16,
            end_line: 29,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /standard/urls::get (standard/urls.trn:29:16-29:32) */,
            file: 0,
            line: 29,
            column: 16,
            end_line: 29,
        ...
        Site {
            function: 
                0 /* terrane-site: site 2: /standard/urls::get (standard/urls.trn:30:24-30:42) */,
            file: 0,
            line: 30,
            column: 24,
            end_line: 30,
        ...
        Site {
            function: 
                0 /* terrane-site: site 3: /standard/urls::get (standard/urls.trn:30:24-30:42) */,
            file: 0,
            line: 30,
            column: 24,
            end_line: 30,
        ...
        Site {
            function: 
                1 /* terrane-site: site 4: /standard/urls::get-all (standard/urls.trn:38:16-38:32) */,
            file: 0,
            line: 38,
            column: 16,
            end_line: 38,
        ...
        Site {
            function: 
                1 /* terrane-site: site 5: /standard/urls::get-all (standard/urls.trn:38:16-38:32) */,
            file: 0,
            line: 38,
            column: 16,
            end_line: 38,
        ...
        Site {
            function: 
                1 /* terrane-site: site 6: /standard/urls::get-all (standard/urls.trn:39:32-39:50) */,
            file: 0,
            line: 39,
            column: 32,
            end_line: 39,
        ...
        Site {
            function: 
                1 /* terrane-site: site 7: /standard/urls::get-all (standard/urls.trn:39:32-39:50) */,
            file: 0,
            line: 39,
            column: 32,
            end_line: 39,
    ...
    pub fn get(&self, name: String) -> String {
            ...
            )
        {
            if __terrane_raised(
                ...
                1 /* terrane-site: standard/urls.trn:29:16-29:32 */,
            ) == name
            {
                return __terrane_raised(
                    self
                        ...
                        .get_or_error(
                            __terrane_raised(
                                terrane_collection_support::index_from_int(&index.clone()),
                                2 /* terrane-site: standard/urls.trn:30:24-30:42 */,
                            ),
                        ),
                    3 /* terrane-site: standard/urls.trn:30:24-30:42 */,
                );
            }
            ...
            if __terrane_raised(
                self
                    ...
                    .get_or_error(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            4 /* terrane-site: standard/urls.trn:38:16-38:32 */,
                        ),
                    ),
                5 /* terrane-site: standard/urls.trn:38:16-38:32 */,
            ) == name
            {
                result
                    .append(
                        __terrane_raised(
                            self
                                ...
                                .get_or_error(
                                    __terrane_raised(
                                        terrane_collection_support::index_from_int(&index.clone()),
                                        6 /* terrane-site: standard/urls.trn:39:32-39:50 */,
                                    ),
                                ),
                            7 /* terrane-site: standard/urls.trn:39:32-39:50 */,
                        ),
                    );
            }
            index = index.clone() + terrane_int_support::Int::from(1_i128);
