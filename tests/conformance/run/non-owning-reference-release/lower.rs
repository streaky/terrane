...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /non-owning-reference-release::main (case.trn:8:12-8:23) */,
            file: 0,
            line: 8,
            column: 12,
            end_line: 8,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /non-owning-reference-release::main (case.trn:8:12-8:23) */,
            file: 0,
            line: 8,
            column: 12,
            end_line: 8,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:8:12-8:23 */)), 1 /* terrane-site: case.trn:8:12-8:23 */))
    );
    let _ = &value;
