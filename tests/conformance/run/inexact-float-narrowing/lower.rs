...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 1] = ["/inexact-float-narrowing::main"];
    pub static SITES: [Site; 1] = [
        /* terrane-site-row: site 0: /inexact-float-narrowing::main (case.trn:4:20-4:26) */
        { Site { function: 0, file: 0, line: 4, column: 20, end_line: 4, end_column: 26 } },
    ];
    #[cold]
    #[inline(never)]
