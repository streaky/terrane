...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = [
        "/callable-mode-throwable-composition::add",
        "/callable-mode-throwable-composition::main",
    ];
    pub static SITES: [Site; 2] = [
        /* terrane-site-row: site 0: /callable-mode-throwable-composition::add (case.trn:9:7-9:27) */
        { Site { function: 0, file: 0, line: 9, column: 7, end_line: 9, end_column: 27 } },
        /* terrane-site-row: site 1: /callable-mode-throwable-composition::main (case.trn:18:11-18:23) */
        { Site { function: 1, file: 0, line: 18, column: 11, end_line: 18, end_column: 23 } },
    ];
    #[cold]
    #[inline(never)]
