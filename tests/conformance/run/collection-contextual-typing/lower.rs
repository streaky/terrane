...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /collection-contextual-typing::main (case.trn:8:10-8:19) */,
            file: 0,
            line: 8,
            column: 10,
            end_line: 8,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /collection-contextual-typing::main (case.trn:8:10-8:19) */,
            file: 0,
            line: 8,
            column: 10,
            end_line: 8,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:8:10-8:19 */)), 1 /* terrane-site: case.trn:8:10-8:19 */))
    );
    if found.is_some() {
        println!(
