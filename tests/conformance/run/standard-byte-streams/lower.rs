...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /standard/streams::read (standard/streams.trn:195:23-195:50) */,
            file: 0,
            line: 195,
            column: 23,
            end_line: 195,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /standard/streams::read-exact (standard/streams.trn:217:23-217:46) */,
            file: 0,
            line: 217,
            column: 23,
            end_line: 217,
        ...
        Site {
            function: 
                2 /* terrane-site: site 2: /standard/streams::read-all (standard/streams.trn:236:23-236:46) */,
            file: 0,
            line: 236,
            column: 23,
            end_line: 236,
        ...
        Site {
            function: 
                3 /* terrane-site: site 3: /standard/streams::read-async (standard/streams.trn:240:16-240:32) */,
            file: 0,
            line: 240,
            column: 16,
            end_line: 240,
...
fn main() {
    ...
    let synced: OperationResult = writer.sync_data();
    if !synced.failed {
        println!(
            "{}",
    ...
    let fully_synced: OperationResult = writer.sync_all();
    ...
    let input_closed: OperationResult = reader.close();
    if input_closed.failed {
        println!("{}", terrane_scalar_support::scalar_text(&input_closed.message));
    }
    let output_closed: OperationResult = writer.close();
