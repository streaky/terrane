...
mod __terrane_error_registry {
    ...
    pub static DESCRIPTORS: [&str; 3] = [
        ...
        "/deps/terrane-nested-outcome-witness::Fault",
    ];
}
mod __terrane_trace {
    pub struct Site {
    ...
    pub static FUNCTIONS: [&str; 2] = ["/app::inspect-next", "/app::inspect-outer"];
    pub static SITES: [Site; 4] = [
        /* terrane-site-row: site 0: /app::inspect-next (src/main.trn:7:16-7:29) */
        { Site { function: 0, file: 0, line: 7, column: 16, end_line: 7, end_column: 29 } },
        /* terrane-site-row: site 1: /app::inspect-next (src/main.trn:9:25-9:41) */
        { Site { function: 0, file: 0, line: 9, column: 25, end_line: 9, end_column: 41 } },
        /* terrane-site-row: site 2: /app::inspect-outer (src/main.trn:18:16-18:29) */
        { Site { function: 1, file: 0, line: 18, column: 16, end_line: 18, end_column: 29 } },
        /* terrane-site-row: site 3: /app::inspect-outer (src/main.trn:20:25-20:42) */
        { Site { function: 1, file: 0, line: 20, column: 25, end_line: 20, end_column: 42 } },
    ];
    #[cold]
    #[inline(never)]
...
// Source: src/main.trn
// Namespace: app
fn inspect_next(mode: i64) {
    let mut connection: Channel = __terrane_raised(
        channel(terrane_int_support::Int::from(mode as i128)),
        0 /* terrane-site: src/main.trn:7:16-7:29 */,
    );
...
fn inspect_outer(mode: i64) {
    let connection: Channel = __terrane_raised(
        channel(terrane_int_support::Int::from(mode as i128)),
        2 /* terrane-site: src/main.trn:18:16-18:29 */,
    );
    let __terrane_completion_1: TerraneCompletion<()> = (|| {
        let __terrane_try_1: TerraneCompletion<()> = (|| {
            ...
            if value.is_some() {
                ...
                println!(
                    "{}", terrane_scalar_support::scalar_text(&String::from("absent"))
                );
            }
            TerraneCompletion::Normal
        })();
...
pub fn channel(
    ...
    let mode = terrane_int_support::coerce::<i64>(&mode)
        .map_err(|error| crate::TerraneForeignError(
            crate::TerraneRaised::raised(error, crate::TERRANE_NO_SITE),
        ))?;
    match std::panic::catch_unwind(
        std::panic::AssertUnwindSafe(|| terrane_nested_outcome_witness::channel(mode)),
    ) {
        Ok(value) => Ok(value),
        Err(payload) => {
            Err(
                crate::__terrane_dependency_panic(
                    payload,
                    "terrane-nested-outcome-witness",
                    "terrane_nested_outcome_witness::channel",
                ),
            )
        }
    }
