...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 1] = ["/collection-property-method-calls::main"];
    pub static SITES: [Site; 3] = [
        /* terrane-site-row: site 0: /collection-property-method-calls::main (case.trn:10:29-10:40) */
        { Site { function: 0, file: 0, line: 10, column: 29, end_line: 10, end_column: 40 } },
        /* terrane-site-row: site 1: /collection-property-method-calls::main (case.trn:11:12-11:21) */
        { Site { function: 0, file: 0, line: 11, column: 12, end_line: 11, end_column: 21 } },
        /* terrane-site-row: site 2: /collection-property-method-calls::main (case.trn:11:23-11:32) */
        { Site { function: 0, file: 0, line: 11, column: 23, end_line: 11, end_column: 32 } },
    ];
    #[cold]
    #[inline(never)]
