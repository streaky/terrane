...
// Runtime support: async.rs, async_cancellable.rs, tasks_threaded.rs, time_base.rs, platform_capability_types.rs, platform_result_type.rs, platform_capability_base.rs, platform_time.rs
...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 12] = [
        /* terrane-site-row: site 0: /task-scope-without-spawn::main (case.trn:6:39-6:65) */
        { Site { function: 0, file: 0, line: 6, column: 39, end_line: 6, end_column: 65 } },
        /* terrane-site-row: site 1: /task-scope-without-spawn::main (case.trn:8:38-8:63) */
