...
mod __terrane_trace {
    ...
    pub static DESCRIPTORS: [&str; 2] = ["shared-error", "shared-error"];
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /app::main (app/main.trn:8:5-8:10) */,
            file: 0,
            line: 8,
            column: 5,
            end_line: 8,
        ...
        Site {
            function: 
                1 /* terrane-site: site 1: /left::fail (left/error.trn:12:3-12:36) */,
            file: 1,
            line: 12,
            column: 3,
            end_line: 12,
