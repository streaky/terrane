...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 5] = [
        /* terrane-site-row: site 0: /stream-zero-length-read::main (case.trn:9:13-9:35) */
        { Site { function: 0, file: 0, line: 9, column: 13, end_line: 9, end_column: 35 } },
        /* terrane-site-row: site 1: /core/streams::read (core/streams.trn:188:23-188:50) */
        { Site { function: 1, file: 1, line: 188, column: 23, end_line: 188, end_column: 50 } },
        /* terrane-site-row: site 2: /core/streams::read-exact (core/streams.trn:210:23-210:46) */
        { Site { function: 2, file: 1, line: 210, column: 23, end_line: 210, end_column: 46 } },
        /* terrane-site-row: site 3: /core/streams::read-all (core/streams.trn:229:23-229:46) */
        { Site { function: 3, file: 1, line: 229, column: 23, end_line: 229, end_column: 46 } },
        /* terrane-site-row: site 4: /core/streams::read-async (core/streams.trn:234:23-234:50) */
        { Site { function: 4, file: 1, line: 234, column: 23, end_line: 234, end_column: 50 } },
    ];
    #[cold]
    #[inline(never)]
...
// Source: case.trn
// Namespace: stream-zero-length-read
fn main() {
    let input: ByteReader = stdin();
    let zero: ReadResult = input.read(terrane_int_support::Int::from(0_i128));
    println!("{}", terrane_scalar_support::scalar_text(&zero.completed));
    println!("{}", terrane_scalar_support::scalar_text(&zero.end));
    let rest: ReadResult = input.read_exact(terrane_int_support::Int::from(3_i128));
    println!(
        "{}",
        terrane_scalar_support::scalar_text(&__terrane_raised(terrane_string_support::decode(&rest
        .data, terrane_string_support::Encoding::Utf8), 0 /* terrane-site: case.trn:9:13-9:35 */))
    );
    input.close();
}
