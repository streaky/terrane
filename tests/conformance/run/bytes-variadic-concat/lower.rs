...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 1] = ["/bytes-variadic-concat::main"];
    pub static SITES: [Site; 2] = [
        /* terrane-site-row: site 0: /bytes-variadic-concat::main (case.trn:7:11-7:32) */
        { Site { function: 0, file: 0, line: 7, column: 11, end_line: 7, end_column: 32 } },
        /* terrane-site-row: site 1: /bytes-variadic-concat::main (case.trn:9:11-9:33) */
        { Site { function: 0, file: 0, line: 9, column: 11, end_line: 9, end_column: 33 } },
    ];
    #[cold]
    #[inline(never)]
...
fn main() {
    let combined: Vec<u8> = {
        ...
        let part_2: Vec<u8> = Vec::from([100]);
        let additional = match [part_0.len(), part_1.len(), part_2.len()]
            .into_iter()
