...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 6] = [
        {
            /* terrane-site-row: site 0: /app::main (src/main.trn:22:13-22:38) */
            Site {
                function: 0,
                file: 0,
                line: 22,
        ...
        {
            /* terrane-site-row: site 1: /app::main (src/main.trn:23:13-23:39) */
            Site {
                function: 0,
                file: 0,
                line: 23,
        ...
        {
            /* terrane-site-row: site 2: /app::main (src/main.trn:24:13-24:45) */
            Site {
                function: 0,
                file: 0,
                line: 24,
        ...
        {
            /* terrane-site-row: site 3: /app::main (src/main.trn:25:28-25:67) */
            Site {
                function: 0,
                file: 0,
                line: 25,
        ...
        {
            /* terrane-site-row: site 4: /app::main (src/main.trn:30:28-30:68) */
            Site {
                function: 0,
                file: 0,
                line: 30,
        ...
        {
            /* terrane-site-row: site 5: /app::main (src/main.trn:33:13-33:49) */
            Site {
                function: 0,
                file: 0,
                line: 33,
...
fn main() {
    __terrane_run(async move {
            ...
            __terrane_await({
                    ...
                    async move {
                        __terrane_raised_err(
                            ...
                            3 /* terrane-site: src/main.trn:25:28-25:67 */,
                        )
                    }
                })
                .await,
        ...
        let concurrent: terrane_int_support::Int = __terrane_traced(
            __terrane_await({
                    ...
                    async move {
                        __terrane_raised_err(
                            __terrane_future.await,
                            4 /* terrane-site: src/main.trn:30:28-30:68 */,
                        )
                    }
                })
                .await,
        ...
        println!(
            ...
            Ok(render(argument_0, argument_1)))), 5 /* terrane-site: src/main.trn:33:13-33:49 */))
        );
    });
}
