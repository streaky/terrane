...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 4] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /references-provenance::main (case.trn:10:25-10:36) */,
            file: 0,
            line: 10,
            column: 25,
            end_line: 10,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /references-provenance::main (case.trn:10:25-10:36) */,
            file: 0,
            line: 10,
            column: 25,
            end_line: 10,
        ...
        Site {
            function: 
                0 /* terrane-site: site 2: /references-provenance::main (case.trn:13:10-13:24) */,
            file: 0,
            line: 13,
            column: 10,
            end_line: 13,
        ...
        Site {
            function: 
                0 /* terrane-site: site 3: /references-provenance::main (case.trn:13:10-13:24) */,
            file: 0,
            line: 13,
            column: 10,
            end_line: 13,
...
fn main() {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:10:25-10:36 */)), 1 /* terrane-site: case.trn:10:25-10:36 */))
    );
    ...
    println!(
        ...
        2 /* terrane-site: case.trn:13:10-13:24 */)), 3 /* terrane-site: case.trn:13:10-13:24 */))
    );
}
