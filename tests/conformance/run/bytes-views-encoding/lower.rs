...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 5] = [
        {
            /* terrane-site-row: site 0: /bytes-views-encoding::main (case.trn:6:20-6:40) */
            Site {
                function: 0,
                file: 0,
                line: 6,
        ...
        {
            /* terrane-site-row: site 1: /bytes-views-encoding::main (case.trn:8:25-8:65) */
            Site {
                function: 0,
                file: 0,
                line: 8,
        ...
        {
            /* terrane-site-row: site 2: /bytes-views-encoding::main (case.trn:9:25-9:65) */
            Site {
                function: 0,
                file: 0,
                line: 9,
        ...
        {
            /* terrane-site-row: site 3: /bytes-views-encoding::main (case.trn:10:25-10:65) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 4: /bytes-views-encoding::main (case.trn:11:25-11:65) */
            Site {
                function: 0,
                file: 0,
                line: 11,
...
fn main() {
    ...
    let decoded: String = __terrane_raised(
        ...
        0 /* terrane-site: case.trn:6:20-6:40 */,
    );
    ...
    let utf16le_text: String = __terrane_raised(
        ...
        1 /* terrane-site: case.trn:8:25-8:65 */,
    );
    let utf16be_text: String = __terrane_raised(
        ...
        2 /* terrane-site: case.trn:9:25-9:65 */,
    );
    let utf32le_text: String = __terrane_raised(
        ...
        3 /* terrane-site: case.trn:10:25-10:65 */,
    );
    let utf32be_text: String = __terrane_raised(
        ...
        4 /* terrane-site: case.trn:11:25-11:65 */,
    );
