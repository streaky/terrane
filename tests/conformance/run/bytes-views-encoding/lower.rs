...
fn main() {
    ...
    let decoded: String = (terrane_string_support::decode(
        &(encoded),
        terrane_string_support::Encoding::Utf8,
    ))
    ...
    let utf16le_text: String = (terrane_string_support::decode(
        ...
        .unwrap_or_else(|error| __terrane_uncaught(
            TerraneError::from(error).at("/bytes-views-encoding::main (case.trn:8:25)"),
        ));
    let utf16be_text: String = (terrane_string_support::decode(
        &(terrane_string_support::encode(
            &(text),
        ...
        .unwrap_or_else(|error| __terrane_uncaught(
            TerraneError::from(error).at("/bytes-views-encoding::main (case.trn:9:25)"),
        ));
    let utf32le_text: String = (terrane_string_support::decode(
        &(terrane_string_support::encode(
            &(text),
        ...
        .unwrap_or_else(|error| __terrane_uncaught(
            TerraneError::from(error).at("/bytes-views-encoding::main (case.trn:10:25)"),
        ));
    let utf32be_text: String = (terrane_string_support::decode(
        &(terrane_string_support::encode(
            &(text),
