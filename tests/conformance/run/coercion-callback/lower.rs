...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 5] = [
        ...
        {
            /* terrane-site-row: site 1: /coercion-callback::main (case.trn:20:11-20:27) */
            Site {
                function: 1,
                file: 0,
                line: 20,
        ...
        {
            /* terrane-site-row: site 2: /coercion-callback::main (case.trn:25:11-25:19) */
            Site {
                function: 1,
                file: 0,
                line: 25,
        ...
        {
            /* terrane-site-row: site 3: /coercion-callback::main (case.trn:26:11-26:19) */
            Site {
                function: 1,
                file: 0,
                line: 26,
        ...
        {
            /* terrane-site-row: site 4: /coercion-callback::main (case.trn:28:13-28:21) */
            Site {
                function: 1,
                file: 0,
                line: 28,
...
fn main() {
    println!(
        ...
        1 /* terrane-site: case.trn:20:11-20:27 */))
    );
    ...
    println!(
        ...
        (terrane_int_support::Int::from(8_i128)), 2 /* terrane-site: case.trn:25:11-25:19 */))
    );
    println!(
        "{}", terrane_scalar_support::scalar_text(&__terrane_traced(bound.clone()
        (terrane_int_support::Int::from(9_i128)), 3 /* terrane-site: case.trn:26:11-26:19 */))
    );
    let __terrane_completion_0: TerraneCompletion<()> = (|| {
        let __terrane_try_0: TerraneCompletion<()> = (|| {
            println!(
                "{}",
                terrane_scalar_support::scalar_text(&__terrane_traced_completion!(std::sync::Arc::new(fail)
                (terrane_int_support::Int::from(7_i128)), 4 /* terrane-site: case.trn:28:13-28:21 */))
            );
