...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /parameter-dead-store-warnings::take (case.trn:6:10-6:14) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /parameter-dead-store-warnings::take (case.trn:6:10-6:14) */,
            file: 0,
            line: 6,
            column: 10,
            end_line: 6,
...
fn take(mut v: terrane_collection_support::List<terrane_int_support::Int>) {
    ...
    println!(
        ...
        0 /* terrane-site: case.trn:6:10-6:14 */)), 1 /* terrane-site: case.trn:6:10-6:14 */))
    );
}
