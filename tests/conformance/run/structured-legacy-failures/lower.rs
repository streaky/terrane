...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 10] = [
        ...
        {
            /* terrane-site-row: site 3: /structured-legacy-failures::round-value (case.trn:18:10-18:24) */
            Site {
                function: 3,
                file: 0,
                line: 18,
        ...
        {
            /* terrane-site-row: site 4: /structured-legacy-failures::narrow-argument (case.trn:23:26-23:30) */
            Site {
                function: 4,
                file: 0,
                line: 23,
        ...
        {
            /* terrane-site-row: site 5: /structured-legacy-failures::main (case.trn:26:13-26:26) */
            Site {
                function: 5,
                file: 0,
                line: 26,
        ...
        {
            /* terrane-site-row: site 7: /structured-legacy-failures::main (case.trn:34:13-34:20) */
            Site {
                function: 5,
                file: 0,
                line: 34,
        ...
        {
            /* terrane-site-row: site 8: /structured-legacy-failures::main (case.trn:38:13-38:25) */
            Site {
                function: 5,
                file: 0,
                line: 38,
        ...
        {
            /* terrane-site-row: site 9: /structured-legacy-failures::main (case.trn:42:13-42:29) */
            Site {
                function: 5,
                file: 0,
                line: 42,
...
fn round_value() -> Result<terrane_int_support::Int, TerraneError> {
    ...
    return Ok(
        __terrane_raised_err(
            ...
            3 /* terrane-site: case.trn:18:10-18:24 */,
        )?,
    );
}
    ...
    return Ok(
        accepts_narrow({
            ...
            __terrane_raised_err(
                ...
                4 /* terrane-site: case.trn:23:26-23:30 */,
            )?
        }),
    );
}
    ...
    let __terrane_completion_0: TerraneCompletion<()> = (|| {
        let __terrane_try_0: TerraneCompletion<()> = (|| {
            println!(
                ...
                5 /* terrane-site: case.trn:26:13-26:26 */))
            );
    ...
    let __terrane_completion_2: TerraneCompletion<()> = (|| {
        let __terrane_try_2: TerraneCompletion<()> = (|| {
            println!(
                ...
                7 /* terrane-site: case.trn:34:13-34:20 */))
            );
            TerraneCompletion::Normal
        })();
    ...
    let __terrane_completion_3: TerraneCompletion<()> = (|| {
        let __terrane_try_3: TerraneCompletion<()> = (|| {
            println!(
                ...
                8 /* terrane-site: case.trn:38:13-38:25 */))
            );
            TerraneCompletion::Normal
        })();
    ...
    let __terrane_completion_4: TerraneCompletion<()> = (|| {
        let __terrane_try_4: TerraneCompletion<()> = (|| {
            println!(
                ...
                9 /* terrane-site: case.trn:42:13-42:29 */))
            );
            TerraneCompletion::Normal
        })();
