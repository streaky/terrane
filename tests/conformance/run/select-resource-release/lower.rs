...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 2] = [
        "/select-resource-release::failing-loser",
        "/select-resource-release::main",
    ];
    pub static SITES: [Site; 3] = [
        /* terrane-site-row: site 0: /select-resource-release::failing-loser (case.trn:19:5-19:25) */
        { Site { function: 0, file: 0, line: 19, column: 5, end_line: 19, end_column: 25 } },
        /* terrane-site-row: site 1: /select-resource-release::main (case.trn:25:19-25:47) */
        { Site { function: 1, file: 0, line: 25, column: 19, end_line: 25, end_column: 47 } },
        /* terrane-site-row: site 2: /select-resource-release::main (case.trn:25:18-25:48) */
        { Site { function: 1, file: 0, line: 25, column: 18, end_line: 25, end_column: 48 } },
    ];
    #[cold]
    #[inline(never)]
        ...
        let __terrane_completion_1: TerraneCompletion<()> = async {
            let __terrane_try_1: TerraneCompletion<()> = async {
                ...
                let mut __terrane_select_future_588_0 = std::pin::pin!(
                    __terrane_select_operation(__terrane_select_control_588_0.clone(),
                    failing_loser(pair.receiver))
                );
                ...
                let mut __terrane_select_future_588_1 = std::pin::pin!(
                    __terrane_select_operation(__terrane_select_control_588_1.clone(),
                    winner())
                );
                ...
                if __terrane_select_winner_588 == usize::MAX {
                    ...
                    __terrane_finish_cancelled_select(__terrane_select_guard_588).await;
                }
