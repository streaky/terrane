...
async fn choose(
    ...
    let mut __terrane_select_future_244_0 = std::pin::pin!(
        __terrane_select_operation(__terrane_select_control_244_0.clone(), Box::pin(left
        .receive()))
    );
    ...
    let mut __terrane_select_future_244_1 = std::pin::pin!(
        __terrane_select_operation(__terrane_select_control_244_1.clone(), Box::pin(right
        .receive()))
    );
    let mut __terrane_select_result_244_1 = None;
    let __terrane_select_winner_244 = std::future::poll_fn(|__terrane_select_context| {
