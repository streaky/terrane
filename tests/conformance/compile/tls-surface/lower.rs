...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 2] = [
        Site {
            function: 
                0 /* terrane-site: site 0: /standard/networking::lookup-dns (standard/networking.trn:326:28-326:49) */,
            file: 0,
            line: 326,
            column: 28,
            end_line: 326,
        ...
        Site {
            function: 
                0 /* terrane-site: site 1: /standard/networking::lookup-dns (standard/networking.trn:326:28-326:49) */,
            file: 0,
            line: 326,
            column: 28,
            end_line: 326,
