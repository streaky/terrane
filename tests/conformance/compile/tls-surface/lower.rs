...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 10] = [
        /* terrane-site-row: site 0: /core/networking::lookup-dns (core/networking.trn:328:28-328:49) */
        { Site { function: 0, file: 0, line: 328, column: 28, end_line: 328, end_column: 49 } },
