...
#[allow(dead_code)] fn terrane_platform_int_rw_lock(initial: terrane_int_support::Int) -> TerranePlatformResult {
...
#[allow(dead_code)] fn terrane_platform_atomic_int64(initial: i64) -> TerranePlatformResult {
...
#[allow(dead_code)] fn terrane_platform_thread_local_int(initial: terrane_int_support::Int) -> TerranePlatformResult {
