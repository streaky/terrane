...
pub fn terrane_platform_tcp_connect(address: String, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::tcp_connect(&address, terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_tcp_connect_host(host: String, port: terrane_int_support::Int, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::tcp_connect_host(&host, terrane_platform_i128!(port, "TCP host port"), terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_tcp_accept(listener: &TerranePlatformCapability, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::tcp_accept(listener, terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_tcp_read(stream: &TerranePlatformCapability, limit: terrane_int_support::Int, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::tcp_read(stream, terrane_platform_i128!(limit, "TCP read limit"), terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_tcp_write(stream: &TerranePlatformCapability, data: Vec<u8>, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::tcp_write(stream, &data, terrane_platform_timeout_nanos(deadline), cancellation) }
...
pub fn terrane_platform_udp_send_to(socket: &TerranePlatformCapability, data: Vec<u8>, address: String, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::udp_send_to(socket, &data, &address, terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_udp_receive_from(socket: &TerranePlatformCapability, limit: terrane_int_support::Int, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::udp_receive_from(socket, terrane_platform_i128!(limit, "UDP receive limit"), terrane_platform_timeout_nanos(deadline), cancellation) }
pub fn terrane_platform_dns_lookup(host: String, port: terrane_int_support::Int, deadline: terrane_int_support::Int, cancellation: &TerranePlatformCapability) -> TerranePlatformResult { terrane_platform_support::dns_lookup(&host, terrane_platform_i128!(port, "DNS port"), terrane_platform_timeout_nanos(deadline), cancellation) }
...
pub async fn terrane_platform_tcp_connect_async(
    ...
    terrane_platform_support::tcp_connect_async(
        &address,
        terrane_platform_timeout_nanos(deadline),
        cancellation,
    )
    .await
}
