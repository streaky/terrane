...
static TERRANE_PROJECTED_CLEANUPS: std::sync::atomic::AtomicUsize =
    std::sync::atomic::AtomicUsize::new(0);
static TERRANE_PROJECTED_CLEANUPS_CHANGED: tokio::sync::Notify =
...
impl Drop for TerraneProjectedEntryGuard {
    fn drop(&mut self) {
        ...
        tokio::spawn(async move {
            ...
            abort.abort();
            if TERRANE_PROJECTED_CLEANUPS.fetch_sub(1, std::sync::atomic::Ordering::SeqCst) == 1 {
