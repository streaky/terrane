...
fn scales_across_ieee_boundaries_with_one_rounding() {
    assert_eq!(scale_binary_f32(1.0, -149), f32::from_bits(1));
    assert_eq!(scale_binary_f32(f32::from_bits(1), 149), 1.0);
    assert_eq!(scale_binary_f32(f32::MAX, 1), f32::INFINITY);
    assert_eq!(scale_binary_f32(1.0, -150), 0.0);

    assert_eq!(scale_binary_f64(1.0, -1074), f64::from_bits(1));
    assert_eq!(scale_binary_f64(f64::from_bits(1), 1074), 1.0);
    assert_eq!(scale_binary_f64(f64::MAX, 1), f64::INFINITY);
    assert_eq!(scale_binary_f64(1.0, -1075), 0.0);
}
