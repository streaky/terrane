...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 14] = [
        ...
        {
            /* terrane-site-row: site 3: /benchmark-bessel-kernel-energy::coordinate (src/main.trn:16:18-16:28) */
            Site {
                function: 1,
                file: 0,
                line: 16,
        ...
        {
            /* terrane-site-row: site 4: /benchmark-bessel-kernel-energy::coordinate (src/main.trn:16:17-16:36) */
            Site {
                function: 1,
                file: 0,
                line: 16,
        ...
        {
            /* terrane-site-row: site 5: /benchmark-bessel-kernel-energy::main (src/main.trn:32:24-32:50) */
            Site {
                function: 2,
                file: 0,
                line: 32,
        ...
        {
            /* terrane-site-row: site 6: /benchmark-bessel-kernel-energy::main (src/main.trn:34:7-34:20) */
            Site {
                function: 2,
                file: 0,
                line: 34,
        ...
        {
            /* terrane-site-row: site 7: /benchmark-bessel-kernel-energy::main (src/main.trn:35:5-35:17) */
            Site {
                function: 2,
                file: 0,
                line: 35,
        ...
        {
            /* terrane-site-row: site 8: /benchmark-bessel-kernel-energy::main (src/main.trn:36:24-36:37) */
            Site {
                function: 2,
                file: 0,
                line: 36,
        ...
        {
            /* terrane-site-row: site 9: /standard/process::arguments (standard/process.trn:45:42-45:56) */
            Site {
                function: 3,
                file: 1,
                line: 45,
        ...
        {
            /* terrane-site-row: site 10: /standard/process::environment (standard/process.trn:54:33-54:47) */
            Site {
                function: 4,
                file: 1,
                line: 54,
        ...
        {
            /* terrane-site-row: site 11: /standard/process::environment (standard/process.trn:55:34-55:52) */
            Site {
                function: 4,
                file: 1,
                line: 55,
        ...
        {
            /* terrane-site-row: site 12: /standard/process::parse-command-line (standard/process.trn:90:20-90:35) */
            Site {
                function: 5,
                file: 1,
                line: 90,
        ...
        {
            /* terrane-site-row: site 13: /standard/process::parse-command-line (standard/process.trn:105:43-105:62) */
            Site {
                function: 5,
                file: 1,
                line: 105,
                        ...
                        encoded
                            .get(
                                __terrane_raised(
                                    ...
                                    9 /* terrane-site: standard/process.trn:45:42-45:56 */,
                                ),
                            )
                            .cloned()
            ...
            __terrane_raised(
                encoded
                    .get(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            10 /* terrane-site: standard/process.trn:54:33-54:47 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
                ...
                encoded
                    .get(
                        __terrane_raised(
                            ...
                            11 /* terrane-site: standard/process.trn:55:34-55:52 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
        ...
        let argument: PlatformString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        12 /* terrane-site: standard/process.trn:90:20-90:35 */,
                    ),
                ),
            12 /* terrane-site: standard/process.trn:90:20-90:35 */,
        );
                                ...
                                supplied
                                    .get_or_error(
                                        __terrane_raised(
                                            ...
                                            13 /* terrane-site: standard/process.trn:105:43-105:62 */,
                                        ),
                                    ),
                                13 /* terrane-site: standard/process.trn:105:43-105:62 */,
                            ),
