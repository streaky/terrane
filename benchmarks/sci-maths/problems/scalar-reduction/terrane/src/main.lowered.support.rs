...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 5] = [
        "/benchmark-scalar-reduction::benchmark-size",
        "/benchmark-scalar-reduction::main",
    ...
    pub static SITES: [Site; 12] = [
        ...
        {
            /* terrane-site-row: site 7: /standard/process::arguments (standard/process.trn:45:42-45:56) */
            Site {
                function: 2,
                file: 1,
                line: 45,
        ...
        {
            /* terrane-site-row: site 8: /standard/process::environment (standard/process.trn:54:33-54:47) */
            Site {
                function: 3,
                file: 1,
                line: 54,
        ...
        {
            /* terrane-site-row: site 9: /standard/process::environment (standard/process.trn:55:34-55:52) */
            Site {
                function: 3,
                file: 1,
                line: 55,
        ...
        {
            /* terrane-site-row: site 10: /standard/process::parse-command-line (standard/process.trn:90:20-90:35) */
            Site {
                function: 4,
                file: 1,
                line: 90,
        ...
        {
            /* terrane-site-row: site 11: /standard/process::parse-command-line (standard/process.trn:105:43-105:62) */
            Site {
                function: 4,
                file: 1,
                line: 105,
                        ...
                        encoded
                            .get(
                                __terrane_raised(
                                    ...
                                    7 /* terrane-site: standard/process.trn:45:42-45:56 */,
                                ),
                            )
                            .cloned()
            ...
            __terrane_raised(
                encoded
                    .get(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            8 /* terrane-site: standard/process.trn:54:33-54:47 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
                ...
                encoded
                    .get(
                        __terrane_raised(
                            ...
                            9 /* terrane-site: standard/process.trn:55:34-55:52 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
        ...
        let argument: PlatformString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        10 /* terrane-site: standard/process.trn:90:20-90:35 */,
                    ),
                ),
            10 /* terrane-site: standard/process.trn:90:20-90:35 */,
        );
                                ...
                                supplied
                                    .get_or_error(
                                        __terrane_raised(
                                            ...
                                            11 /* terrane-site: standard/process.trn:105:43-105:62 */,
                                        ),
                                    ),
                                11 /* terrane-site: standard/process.trn:105:43-105:62 */,
                            ),
