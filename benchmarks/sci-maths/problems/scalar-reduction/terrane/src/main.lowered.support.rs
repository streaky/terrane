...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 12] = [
        ...
        {
            /* terrane-site-row: site 10: /core/process::parse-command-line (core/process.trn:89:20-89:35) */
            Site {
                function: 4,
                file: 1,
                line: 89,
        ...
        {
            /* terrane-site-row: site 11: /core/process::parse-command-line (core/process.trn:104:43-104:62) */
            Site {
                function: 4,
                file: 1,
                line: 104,
        ...
        let argument: NativeString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        10 /* terrane-site: core/process.trn:89:20-89:35 */,
                    ),
                ),
            10 /* terrane-site: core/process.trn:89:20-89:35 */,
        );
                                ...
                                supplied
                                    .get_or_error(
                                        __terrane_raised(
                                            ...
                                            11 /* terrane-site: core/process.trn:104:43-104:62 */,
                                        ),
                                    ),
                                11 /* terrane-site: core/process.trn:104:43-104:62 */,
                            ),
