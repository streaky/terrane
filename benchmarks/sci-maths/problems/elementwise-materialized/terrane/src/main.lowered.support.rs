...
mod __terrane_trace {
    ...
    pub static SITES: [Site; 10] = [
        {
            /* terrane-site-row: site 0: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:10:18-10:29) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 1: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:10:18-10:44) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 2: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:10:17-10:45) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 3: /benchmark-elementwise-materialized::main (src/main.trn:21:19-21:31) */
            Site {
                function: 1,
                file: 0,
                line: 21,
        ...
        {
            /* terrane-site-row: site 4: /benchmark-elementwise-materialized::main (src/main.trn:24:5-24:12) */
            Site {
                function: 1,
                file: 0,
                line: 24,
        ...
        {
            /* terrane-site-row: site 5: /standard/process::arguments (standard/process.trn:45:42-45:56) */
            Site {
                function: 2,
                file: 1,
                line: 45,
        ...
        {
            /* terrane-site-row: site 6: /standard/process::environment (standard/process.trn:54:33-54:47) */
            Site {
                function: 3,
                file: 1,
                line: 54,
        ...
        {
            /* terrane-site-row: site 7: /standard/process::environment (standard/process.trn:55:34-55:52) */
            Site {
                function: 3,
                file: 1,
                line: 55,
        ...
        {
            /* terrane-site-row: site 8: /standard/process::parse-command-line (standard/process.trn:90:20-90:35) */
            Site {
                function: 4,
                file: 1,
                line: 90,
        ...
        {
            /* terrane-site-row: site 9: /standard/process::parse-command-line (standard/process.trn:105:43-105:62) */
            Site {
                function: 4,
                file: 1,
                line: 105,
                        ...
                        encoded
                            .get(
                                __terrane_raised(
                                    ...
                                    5 /* terrane-site: standard/process.trn:45:42-45:56 */,
                                ),
                            )
                            .cloned()
            ...
            __terrane_raised(
                encoded
                    .get(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            6 /* terrane-site: standard/process.trn:54:33-54:47 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
                ...
                encoded
                    .get(
                        __terrane_raised(
                            ...
                            7 /* terrane-site: standard/process.trn:55:34-55:52 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
        ...
        let argument: PlatformString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        8 /* terrane-site: standard/process.trn:90:20-90:35 */,
                    ),
                ),
            8 /* terrane-site: standard/process.trn:90:20-90:35 */,
        );
                                ...
                                supplied
                                    .get_or_error(
                                        __terrane_raised(
                                            ...
                                            9 /* terrane-site: standard/process.trn:105:43-105:62 */,
                                        ),
                                    ),
                                9 /* terrane-site: standard/process.trn:105:43-105:62 */,
                            ),
