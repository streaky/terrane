...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 5] = [
        "/benchmark-elementwise-materialized::benchmark-size",
        "/benchmark-elementwise-materialized::main",
    ...
    pub static SITES: [Site; 10] = [
        {
            /* terrane-site-row: site 0: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:11:18-11:29) */
            Site {
                function: 0,
                file: 0,
                line: 11,
        ...
        {
            /* terrane-site-row: site 1: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:11:18-11:44) */
            Site {
                function: 0,
                file: 0,
                line: 11,
        ...
        {
            /* terrane-site-row: site 2: /benchmark-elementwise-materialized::benchmark-size (src/main.trn:11:17-11:45) */
            Site {
                function: 0,
                file: 0,
                line: 11,
        ...
        {
            /* terrane-site-row: site 3: /benchmark-elementwise-materialized::main (src/main.trn:22:19-22:31) */
            Site {
                function: 1,
                file: 0,
                line: 22,
        ...
        {
            /* terrane-site-row: site 4: /benchmark-elementwise-materialized::main (src/main.trn:25:5-25:12) */
            Site {
                function: 1,
                file: 0,
                line: 25,
        ...
        {
            /* terrane-site-row: site 5: /standard/process::arguments (standard/process.trn:51:42-51:56) */
            Site {
                function: 2,
                file: 1,
                line: 51,
        ...
        {
            /* terrane-site-row: site 6: /standard/process::environment (standard/process.trn:60:33-60:47) */
            Site {
                function: 3,
                file: 1,
                line: 60,
        ...
        {
            /* terrane-site-row: site 7: /standard/process::environment (standard/process.trn:61:34-61:52) */
            Site {
                function: 3,
                file: 1,
                line: 61,
        ...
        {
            /* terrane-site-row: site 8: /standard/process::parse-command-line (standard/process.trn:96:20-96:35) */
            Site {
                function: 4,
                file: 1,
                line: 96,
        ...
        {
            /* terrane-site-row: site 9: /standard/process::parse-command-line (standard/process.trn:111:43-111:62) */
            Site {
                function: 4,
                file: 1,
                line: 111,
                        ...
                        encoded
                            .get(
                                __terrane_raised(
                                    ...
                                    5 /* terrane-site: standard/process.trn:51:42-51:56 */,
                                ),
                            )
                            .cloned()
            ...
            __terrane_raised(
                encoded
                    .get(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            6 /* terrane-site: standard/process.trn:60:33-60:47 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
                ...
                encoded
                    .get(
                        __terrane_raised(
                            ...
                            7 /* terrane-site: standard/process.trn:61:34-61:52 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
        ...
        let argument: PlatformString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        8 /* terrane-site: standard/process.trn:96:20-96:35 */,
                    ),
                ),
            8 /* terrane-site: standard/process.trn:96:20-96:35 */,
        );
