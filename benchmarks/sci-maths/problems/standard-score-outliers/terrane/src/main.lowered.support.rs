...
mod __terrane_trace {
    ...
    pub static FILES: [&str; 2] = ["src/main.trn", "core/process.trn"];
    ...
    pub static SITES: [Site; 13] = [
        ...
        {
            /* terrane-site-row: site 8: /core/process::arguments (core/process.trn:44:49-44:63) */
            Site {
                function: 2,
                file: 1,
                line: 44,
        ...
        {
            /* terrane-site-row: site 9: /core/process::environment (core/process.trn:53:40-53:54) */
            Site {
                function: 3,
                file: 1,
                line: 53,
        ...
        {
            /* terrane-site-row: site 10: /core/process::environment (core/process.trn:54:41-54:59) */
            Site {
                function: 3,
                file: 1,
                line: 54,
        ...
        {
            /* terrane-site-row: site 11: /core/process::parse-command-line (core/process.trn:89:20-89:35) */
            Site {
                function: 4,
                file: 1,
                line: 89,
        ...
        {
            /* terrane-site-row: site 12: /core/process::parse-command-line (core/process.trn:104:43-104:62) */
            Site {
                function: 4,
                file: 1,
                line: 104,
                            ...
                            encoded
                                .get(
                                    __terrane_raised(
                                        ...
                                        8 /* terrane-site: core/process.trn:44:49-44:63 */,
                                    ),
                                )
                                .cloned()
                ...
                __terrane_raised(
                    encoded
                        .get(
                            __terrane_raised(
                                terrane_collection_support::index_from_int(&index.clone()),
                                9 /* terrane-site: core/process.trn:53:40-53:54 */,
                            ),
                        )
                        .cloned()
                        .ok_or(terrane_collection_support::IndexError {
                    ...
                    encoded
                        .get(
                            __terrane_raised(
                                ...
                                10 /* terrane-site: core/process.trn:54:41-54:59 */,
                            ),
                        )
                        .cloned()
                        .ok_or(terrane_collection_support::IndexError {
            ...
            let argument: NativeString = __terrane_raised(
                supplied
                    .get_or_error(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            11 /* terrane-site: core/process.trn:89:20-89:35 */,
                        ),
                    ),
                11 /* terrane-site: core/process.trn:89:20-89:35 */,
            );
                                    ...
                                    supplied
                                        .get_or_error(
                                            __terrane_raised(
                                                ...
                                                12 /* terrane-site: core/process.trn:104:43-104:62 */,
                                            ),
                                        ),
                                    12 /* terrane-site: core/process.trn:104:43-104:62 */,
                                ),
