...
mod __terrane_trace {
    ...
    pub static FUNCTIONS: [&str; 5] = [
        "/benchmark-standard-score-outliers::benchmark-size",
        "/benchmark-standard-score-outliers::main",
    ...
    pub static SITES: [Site; 13] = [
        {
            /* terrane-site-row: site 0: /benchmark-standard-score-outliers::benchmark-size (src/main.trn:10:18-10:29) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 1: /benchmark-standard-score-outliers::benchmark-size (src/main.trn:10:18-10:44) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 2: /benchmark-standard-score-outliers::benchmark-size (src/main.trn:10:17-10:45) */
            Site {
                function: 0,
                file: 0,
                line: 10,
        ...
        {
            /* terrane-site-row: site 3: /benchmark-standard-score-outliers::main (src/main.trn:22:19-22:38) */
            Site {
                function: 1,
                file: 0,
                line: 22,
        ...
        {
            /* terrane-site-row: site 4: /benchmark-standard-score-outliers::main (src/main.trn:23:24-23:33) */
            Site {
                function: 1,
                file: 0,
                line: 23,
        ...
        {
            /* terrane-site-row: site 5: /benchmark-standard-score-outliers::main (src/main.trn:27:5-27:12) */
            Site {
                function: 1,
                file: 0,
                line: 27,
        ...
        {
            /* terrane-site-row: site 6: /benchmark-standard-score-outliers::main (src/main.trn:29:21-29:26) */
            Site {
                function: 1,
                file: 0,
                line: 29,
        ...
        {
            /* terrane-site-row: site 7: /benchmark-standard-score-outliers::main (src/main.trn:41:7-41:17) */
            Site {
                function: 1,
                file: 0,
                line: 41,
        ...
        {
            /* terrane-site-row: site 8: /standard/process::arguments (standard/process.trn:45:42-45:56) */
            Site {
                function: 2,
                file: 1,
                line: 45,
        ...
        {
            /* terrane-site-row: site 9: /standard/process::environment (standard/process.trn:54:33-54:47) */
            Site {
                function: 3,
                file: 1,
                line: 54,
        ...
        {
            /* terrane-site-row: site 10: /standard/process::environment (standard/process.trn:55:34-55:52) */
            Site {
                function: 3,
                file: 1,
                line: 55,
        ...
        {
            /* terrane-site-row: site 11: /standard/process::parse-command-line (standard/process.trn:90:20-90:35) */
            Site {
                function: 4,
                file: 1,
                line: 90,
        ...
        {
            /* terrane-site-row: site 12: /standard/process::parse-command-line (standard/process.trn:105:43-105:62) */
            Site {
                function: 4,
                file: 1,
                line: 105,
                        ...
                        encoded
                            .get(
                                __terrane_raised(
                                    ...
                                    8 /* terrane-site: standard/process.trn:45:42-45:56 */,
                                ),
                            )
                            .cloned()
            ...
            __terrane_raised(
                encoded
                    .get(
                        __terrane_raised(
                            terrane_collection_support::index_from_int(&index.clone()),
                            9 /* terrane-site: standard/process.trn:54:33-54:47 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
                ...
                encoded
                    .get(
                        __terrane_raised(
                            ...
                            10 /* terrane-site: standard/process.trn:55:34-55:52 */,
                        ),
                    )
                    .cloned()
                    .ok_or(terrane_collection_support::IndexError {
        ...
        let argument: PlatformString = __terrane_raised(
            supplied
                .get_or_error(
                    __terrane_raised(
                        terrane_collection_support::index_from_int(&index.clone()),
                        11 /* terrane-site: standard/process.trn:90:20-90:35 */,
                    ),
                ),
            11 /* terrane-site: standard/process.trn:90:20-90:35 */,
        );
                                ...
                                supplied
                                    .get_or_error(
                                        __terrane_raised(
                                            ...
                                            12 /* terrane-site: standard/process.trn:105:43-105:62 */,
                                        ),
                                    ),
                                12 /* terrane-site: standard/process.trn:105:43-105:62 */,
                            ),
