...
program. A shebang-bearing single-file script may omit `namespace`; the compiler supplies an
implementation-owned namespace for that unit. It must still declare a parameterless top-level `main`.
