...
projection_schema: full rustdoc document deserialized through version-matched rustdoc-types; toolchain pin + FORMAT_VERSION + schema crate + cache schema 50 are one unit; malformed/mismatched input fails explicitly, representability limits are recorded declines
