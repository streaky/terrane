...
projection_oracle: deterministic contained minimal crate; batched concrete bound and macro-expansion questions; answers yes/no/unknown where only rustc bound failure is no; caches under projection identity and records evidence/count/wall-time in artifact
