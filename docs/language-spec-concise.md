...
- Synchronization cells require `threads`; their opaque capability-bearing objects share synchronized identity on assignment/argument passage, explicit object semantics rather than a mutex silently added to ordinary values.
